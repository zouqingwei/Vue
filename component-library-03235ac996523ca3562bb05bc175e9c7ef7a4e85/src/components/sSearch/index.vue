<template>
  <div>
    <ul class="search-list">
      <li v-for="(info,index) in search" class="search-item" :class="{'date-time':info.type === 2}" :key="index">
    ...
    <ul class="search-list">
      <li v-for="(info,index) in searchbtn" class="search-btn" :class="{'all-btn': info.type === 3}" :key="index">
